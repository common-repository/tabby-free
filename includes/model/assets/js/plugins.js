...
(function($) {
  ...
  function AGWP_TABBYAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  AGWP_TABBYAjaxChosen.prototype.init = function() {
  ...
  AGWP_TABBYAjaxChosen.prototype.events = function() {
  ...
  AGWP_TABBYAjaxChosen.prototype.search_field_focused = function() {
  ...
  AGWP_TABBYAjaxChosen.prototype.search_welcome_message = function() {
  ...
  AGWP_TABBYAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('agm-chosen', _this.options.data).done( function( response ) {
  ...
  AGWP_TABBYAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.agm-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.AGWP_TABBYChosenOrder($hidden_value, true);
  ...
  $.fn.AGWP_TABBYAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new AGWP_TABBYAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, AGWP_TABBYAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  AGWP_TABBYAbstractChosenOrder = (function() {

    function AGWP_TABBYAbstractChosenOrder() {}

    AGWP_TABBYAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index]);
    };

    AGWP_TABBYAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    AGWP_TABBYAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    AGWP_TABBYAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    AGWP_TABBYAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    AGWP_TABBYAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    AGWP_TABBYAbstractChosenOrder.AGWP_TABBYChosenOrder = function(select, order, force) {
    ...
    return AGWP_TABBYAbstractChosenOrder;
  ...
  $.fn.extend({
    AGWP_TABBYChosenOrder: function(order, force) {
      return _AGWP_TABBYChosenOrder.AGWP_TABBYChosenOrder(this, order, force);
    }
  });

  this._AGWP_TABBYChosenOrder = (function(_super) {
    __extends(_AGWP_TABBYChosenOrder, _super);

    function _AGWP_TABBYChosenOrder() {
      _ref = _AGWP_TABBYChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _AGWP_TABBYChosenOrder.relAttributeName = 'data-option-array-index';

    _AGWP_TABBYChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _AGWP_TABBYChosenOrder.getDOMElement = function(element) {
    ...
    _AGWP_TABBYChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _AGWP_TABBYChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _AGWP_TABBYChosenOrder;

  })(AGWP_TABBYAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('agm-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectAGWP_TABBY = FormSerializer.serializeObject;
    $.fn.serializeJSONAGWP_TABBY   = FormSerializer.serializeJSON;
  }
