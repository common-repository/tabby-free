 ...
 * -----------------------------------------------------------
 *
 * APPGLUT Framework Gutenberg Block
...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.agm_gutenberg_blocks ) { return; }

  Object.values(window.agm_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType('agm-gutenberg-block/block-'+block.hash, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'agm-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.hash,
              className: 'is-secondary agm-shortcode-button',
              onClick: function () {
                window.agm_gutenberg_props = props;
              },
            }, block.button_title ),
