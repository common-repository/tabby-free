 ...
 *
 */
if ( ! class_exists( 'AGWP_TABBY_select' ) ) {
  class AGWP_TABBY_select extends AGWP_TABBYP {
      ...
      if ( isset( $this->field['options'] ) ) {
        ...
        if ( ( is_array( $options ) && ! empty( $options ) ) || ( ! empty( $args['chosen'] ) && ! empty( $args['ajax'] ) ) ) {
          ...
          if ( ! empty( $args['chosen'] ) && ! empty( $args['multiple'] ) ) {
            ...
            echo '<select name="'. esc_attr($field_name) .'" class="agm-hide-select hidden"'. esc_attr($multiple_attr) . esc_attr($field_attr) .'>';
