 ...
 *
 */
if ( ! class_exists( 'AGWP_TABBY_color' ) ) {
  class AGWP_TABBY_color extends AGWP_TABBYP {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="agm-color"'. esc_attr($default_attr) . wp_kses_post($this->field_attributes()) .'/>';
