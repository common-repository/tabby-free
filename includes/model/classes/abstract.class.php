 ...
 *
 */
if ( ! class_exists( 'AGWP_TABBY_Abstract' ) ) {
  abstract class AGWP_TABBY_Abstract {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          if ( $field_type && $field_id ) {
            ...
            AGWP_TABBY::maybe_include_field( $field_type );

            $class_name = 'AGWP_TABBY_' . $field_type;
            ...
            if ( class_exists( $class_name ) ) {
              ...
              if ( method_exists( $class_name, 'output' ) || method_exists( $class_name, 'enqueue_google_fonts' ) ) {
                ...
                if ( $field_output && $this->args['output_css'] ) {
                  AGWP_TABBY::$css .= $instance->output();
                }
