    ...
    <div class="wt-tabs-btn-container<?php echo esc_attr($post_id); ?> wt-body-style">
      ...
      ?>
        <a class="wt-btn<?php echo esc_attr($post_id); ?> wt-tabs-tb<?php echo esc_attr($post_id); ?> wt-tabs-top <?php if ($wp_tabby_data_count_id == 1): ?> active <?php endif;?>"
            ...
            <img src="<?php echo esc_attr($single_icon['meta_value']['taxonomy_wp_tabby_custom_icon']['url']); ?>" alt="Custom Icon" width="<?php echo $content_display_options['wp_tabby_settings_options']['agwp_tabby_tabs_icon_size']['all'];  ?>">
