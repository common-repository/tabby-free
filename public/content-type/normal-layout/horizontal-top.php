...
<?php endif;?>
    ...
    <!-- Tabs Button -->
    <div class="wt-tabs-btn-container<?php echo esc_attr($post_id); ?> wt-body-style">
        <?php
if (is_array($content_data['agwp_tabby_content']) || is_object($content_data['agwp_tabby_content'])):
    ...
    foreach ($content_data['agwp_tabby_content'] as $single_data):
        ...
        ?>
            ...
            <img src="<?php echo esc_attr($single_data['wp_tabby_custom_icon']['url']); ?>" alt="Custom Icon" width="<?php echo $content_display_options['wp_tabby_settings_options']['agwp_tabby_tabs_icon_size']['all'] ?>">
            <?php endif;?>
...
endforeach;
    ...
    <?php if (is_array($content_data['agwp_tabby_content']) || is_object($content_data['agwp_tabby_content'])): ?>
    <!-- Tabs Body -->
    <div class="wt-tabs-body wt-body<?php echo esc_attr($post_id); ?>">
       ...
       foreach ($content_data['agwp_tabby_content'] as $single_data):
    $wp_tabby_control_id = "wt-tab" . $post_id . $wp_tabby_data_count_id;
    if (!empty($single_data['wp_tabby_content'])):
...
<?php echo wp_kses_post(apply_filters( 'the_content', $single_data['wp_tabby_content'])); ?>
        ...
        <?php $wp_tabby_data_count_id++;endforeach;?>
